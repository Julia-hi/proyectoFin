                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card mb-4 box-shadow">
                                        ...
                                        <img class="card-img-top" src="" alt="{{ $oferta->title }}" style="height: 225px; width: 100%; display: block;" src="" data-holder-rendered="true">
                                        @endforeach
                                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="card mb-4 box-shadow">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-sm btn-outline-secondary" title="ver anuncio">Ver</button>
                                                    <button type="button" class="btn btn-sm btn-outline-secondary" title="enviar mensaje al anunciante">Enviar mensaje</button>
