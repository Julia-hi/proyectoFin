                    ...
                    <div class="pt-3">
                        ...
                        <div class="border border-green rounded mt-2 p-0 bg-white">
                            <div class="row border-bottom m-0 py-1 bg-green text-white align-items-center">
                                <div class="col-lg-1 d-none d-sm-none d-lg-block text-center text-uppercase">id</div>
                                <div class="col-lg-2 d-none d-sm-none d-lg-block text-center text-uppercase">titulo</div>
                                <div class="col-lg-6 d-none d-sm-none d-lg-block text-center text-uppercase">Descripción</div>
                                <div class="col-lg-3 d-none d-sm-none d-lg-block text-uppercase">opciones</div>
                            </div>
                            @foreach ($demandas as $demanda)
                            <div class="row w-100 m-0 p-2 align-items-center">
                                <div class="col-1 text-left"> {{ $demanda->id }}
                                    @if($demanda->anuncio->estado == "blocked")
                                    <button class="btn btn-sm btn-danger px-2 ml-1" title="Anuncio bloqueado">!</button>
                                    @endif
                                </div>
                                <div class="col-xs-12 col-lg-2 text-left"> {{ $demanda->titulo }}</div>
                                <div class="col-lg-6 col-xs-12 text-left"> {{ $demanda->descripcion }}</div>
                        ...
                        <div class="border border-green rounded mt-2 p-0 bg-white">
                            <div class="row border-bottom m-0 py-1 bg-green text-white align-items-center">
                                <div class="col-lg-1 d-none d-sm-none d-lg-block border-right text-center text-uppercase">Id</div>
                                <div class="col-lg-2 d-none d-sm-none d-lg-block border-right text-center text-uppercase">Titulo</div>
                                <div class="col-lg-1 d-none d-sm-none d-lg-block border-right text-center text-uppercase">Foto</div>
                                <div class="col-lg-5 d-none d-sm-none d-lg-block border-right text-center text-uppercase">Descripción</div>
                                <div class="col-lg-3 d-none d-sm-none d-lg-block border-left text-uppercase">opciones</div>
                            </div>
                            @foreach ($ofertas as $oferta)
                            <div class="row w-100 m-0 align-items-center">
                                <div class="col-1 text-left"> {{ $oferta->id }}
                                    @if($oferta->anuncio->estado == "blocked")
                                    <button class="btn btn-sm btn-danger px-2 ml-1" title="Anuncio bloqueado">!</button>
                                    @endif
                                </div>
                                <div class="col-lg-2 col-xs-6 text-left"> {{ $oferta->titulo }} </div>
                                <div class="col-lg-1 ">
                                ...
                                <div class="col-lg-5 col-xs-12 text-left"> {{ $oferta->descripcion }} </div>
                                <div class="col-lg-3 col-xs-12">
                                    <div class="btn-group  align-items-center">
                                        <?php $url = '/ofertas/' . $oferta->id; ?>
                                        <a href="<?php echo $url; ?>" role="button" class="btn btn-sm btn-outline-success text-uppercase w-auto"><b>Ver</b></a>
                                        <a href="{{route('user.anuncios-oferta.edit',['user'=>Auth::user()->id,'anuncios_ofertum'=>$oferta->id] )}}" role="button" class="modificar_anuncio w-auto btn btn-sm btn-outline-warning text-uppercase"><b>Modificar</b></a>
                                        <form action="{{ route('user.anuncios-oferta.destroy', ['user'=>Auth::user()->id,'anuncios_ofertum'=>$oferta->id]) }}" method="POST">
                                            ...
                                            <button type="submit" class="eliminar_anuncio btn btn-sm btn-outline-danger text-uppercase w-auto"><b>Eliminar</b></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
